...
using SilkGamepadButton = Silk.NET.Input.ButtonName;

namespace RedHerring.Fingerprint;

public static class InputExtensions
{
    internal static Key ConvertKey(SilkKey key)
    {
        return key switch
        {
    ...
    internal static GamepadButton ConvertGamepadButton(SilkGamepadButton button)
    {
        return button switch
        {
            SilkGamepadButton.Unknown => GamepadButton.Unknown,
            SilkGamepadButton.A => GamepadButton.A,
            SilkGamepadButton.B => GamepadButton.B,
            SilkGamepadButton.X => GamepadButton.X,
            SilkGamepadButton.Y => GamepadButton.Y,
            SilkGamepadButton.LeftBumper => GamepadButton.LeftBumper,
            SilkGamepadButton.RightBumper => GamepadButton.RightBumper,
            SilkGamepadButton.Back => GamepadButton.Back,
            SilkGamepadButton.Start => GamepadButton.Start,
            SilkGamepadButton.Home => GamepadButton.Home,
            SilkGamepadButton.LeftStick => GamepadButton.LeftStick,
            SilkGamepadButton.RightStick => GamepadButton.RightStick,
            SilkGamepadButton.DPadUp => GamepadButton.DPadUp,
            SilkGamepadButton.DPadRight => GamepadButton.DPadRight,
            SilkGamepadButton.DPadDown => GamepadButton.DPadDown,
            SilkGamepadButton.DPadLeft => GamepadButton.DPadLeft,
