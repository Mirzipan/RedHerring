...
public static class Primitives
{
    public static MeshData Plane(int width, int height, int uvUnit)
    {
        ...
        {
            new VertexPositionNormalTexture(new Vector3(-halfWidth, 0, -halfHeight), Vector3.UnitY,
    ...
    public static MeshData Box(float width, float height, float depth, float uvUnit)
    {
        ...
        {
            // Top
            new VertexPositionNormalTexture(new Vector3(-halfWidth, +halfHeight, -halfDepth), new Vector3(0, 1, 0),
                new Vector2(0, 0) * uvScale),
            new VertexPositionNormalTexture(new Vector3(+halfWidth, +halfHeight, -halfDepth), new Vector3(0, 1, 0),
                new Vector2(1, 0) * uvScale),
            new VertexPositionNormalTexture(new Vector3(+halfWidth, +halfHeight, +halfDepth), new Vector3(0, 1, 0),
            ...
            new VertexPositionNormalTexture(new Vector3(-halfWidth, -halfHeight, -halfDepth), new Vector3(0, -1, 0),
                new Vector2(0, 1) * uvScale),
            // Left                                                               
            new VertexPositionNormalTexture(new Vector3(-halfWidth, +halfHeight, -halfDepth), new Vector3(-1, 0, 0),
                new Vector2(0, 0) * uvScale),
            new VertexPositionNormalTexture(new Vector3(-halfWidth, +halfHeight, +halfDepth), new Vector3(-1, 0, 0),
                new Vector2(1, 0) * uvScale),
            new VertexPositionNormalTexture(new Vector3(-halfWidth, -halfHeight, +halfDepth), new Vector3(-1, 0, 0),
            ...
            new VertexPositionNormalTexture(new Vector3(+halfWidth, -halfHeight, +halfDepth), new Vector3(1, 0, 0),
                new Vector2(0, 1) * uvScale),
            // Back                                                               
            new VertexPositionNormalTexture(new Vector3(+halfWidth, +halfHeight, -halfDepth), new Vector3(0, 0, -1),
                new Vector2(0, 0) * uvScale),
            new VertexPositionNormalTexture(new Vector3(-halfWidth, +halfHeight, -halfDepth), new Vector3(0, 0, -1),
                new Vector2(1, 0) * uvScale),
            new VertexPositionNormalTexture(new Vector3(-halfWidth, -halfHeight, -halfDepth), new Vector3(0, 0, -1),
